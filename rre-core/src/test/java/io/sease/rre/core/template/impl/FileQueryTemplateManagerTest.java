...
/**
 * Unit tests for the basic file query template manager.
 *
 * @author Matt Pearce (matt@elysiansoftware.co.uk)
 */
public class FileQueryTemplateManagerTest {
    ...
    public void initialiseTemplateManager() {
        this.templateManager = new FileQueryTemplateManager(folder.getRoot());
    }
